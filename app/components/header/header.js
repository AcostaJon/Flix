...
export default function Header(props) {
    ...
    const notificationBell = (e) => {
        props.callBacks.notificationIcon(e)
    }
    // hamburger icon handler
    const hamburgerMenu = (e) => {
        props.callBacks.hamburgerIcon(e)
    }

    return (
        // header
        <header id='header' className={styles.header} style={{ top: scroll }} >
            {/* container */}
            <div className={styles.headerContainer}>
                ...
                <div className={styles.rightSide}>
                    ...
                    {props.components.showNotificationList}
                    {/* hamburger icon */}
                    ...
                    {props.components.offCanvasMenu}
                </div>
            </div>
        </header>
    )
